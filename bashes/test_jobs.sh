...
#SBATCH --output=/n/fs/xl-diffbia/projects/stable-diffusion/slurm_output/2023-09-13/sample_test_jobs.txt            # where stdout and stderr will write to
...
CUDA_VISIBLE_DEVICES=0 python occupations/utils.py