...
#SBATCH --output=/n/fs/xl-diffbia/projects/stable-diffusion/slurm_output/2023-11-03/sample_jobs.txt            # where stdout and stderr will write to
...
CUDA_VISIBLE_DEVICES=0 python occupations/utils.py --date 2023-11-03 --batch-size 50 --num-batch 4 --curr-batch 3 --curr-run 9