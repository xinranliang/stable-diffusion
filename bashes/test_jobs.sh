...
#SBATCH --output=/n/fs/xl-diffbia/projects/stable-diffusion/slurm_output/2023-09-13/sample_jobs_batch5.txt            # where stdout and stderr will write to
...
CUDA_VISIBLE_DEVICES=0 python occupations/utils.py --batch-size 100 --num-batch 5 --curr-batch 4