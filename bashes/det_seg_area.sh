...
#SBATCH --output=/n/fs/xl-diffbia/projects/stable-diffusion/slurm_output/2023-10-26/eval_detseg_area.txt            # where stdout and stderr will write to
...
python quality_metrics/det_seg.py --master-folder /n/fs/xl-diffbia/projects/stable-diffusion/logs/samples/2023-10-26