...
#SBATCH --output=/n/fs/xl-diffbia/projects/stable-diffusion/slurm_output/2023-11-02/sample_generic.txt            # where stdout and stderr will write to
...
CUDA_VISIBLE_DEVICES=0 python occupations/utils.py --date 2023-11-02 --batch-size 50 --num-batch 1 --curr-batch 0 --curr-run 9